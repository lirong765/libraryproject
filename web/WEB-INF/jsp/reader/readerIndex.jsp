...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '<%=basePath%>queryReaderAll',//查询读者数据
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'cardnumber', width: 200, title: '卡号'},
                ...
                {templet: "<div>{{layui.util.toDateString(d.creat_date, 'yyyy-MM-dd HH:mm:ss')}}</div>", width: 200, title: '办卡时间'},
