            ...
            cols: [[
                ...
                {field: 'type', width: 280, title: '管理员类型',
                 templet:function (res) {    //类型
                    if(res.type=='0'){
                        return '<span class="layui-btn layui-btn-xs layui-btn-danger data-count-delete">高级管理员</span>'
                    } else {
                        return '<span class="layui-btn layui-btn-normal layui-btn-xs data-count-edit">普通管理员</span>'
                    }
                }},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {  // 监听修改操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['60%', '60%'],
                    content: '<%=basePath%>queryAdminInfoById?id='+data.id,
                });
