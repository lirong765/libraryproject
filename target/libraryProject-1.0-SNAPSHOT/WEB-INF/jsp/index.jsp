            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" layuimini-content-href="<%= basePath%>page/user-password.html" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
    ...
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            <c:choose>
                <c:when test="${sessionScope.type.equals('reader')}">
                    iniUrl: "<%= basePath%>api/init2.json",    // 初始化接口
                </c:when>
                <c:otherwise>
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '<%= basePath%>loginOut';
            });
        });
    });
</script>
