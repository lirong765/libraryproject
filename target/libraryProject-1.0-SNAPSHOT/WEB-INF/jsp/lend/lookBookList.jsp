    ...
    <li class="layui-timeline-item">
        ...
        <div class="layui-timeline-content layui-text">
            <div class="layui-timeline-title">
                <fmt:formatDate value="${lend.leadDate}" pattern="yyyy年MM月dd日HH点mm分ss秒" /> <br/>
                <span style="color: red"> ${lend.readerCard.name}</span> 借走< <span style="color: crimson">${lend.bookInfo.name}</span> ><br/>
